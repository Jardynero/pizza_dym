...
class AddItemToBdScreen extends StatefulWidget {
  AddItemToBdScreen({Key? key}) : super(key: key);
  ...
  @override
  State<AddItemToBdScreen> createState() => _AddItemToBdScreenState();
}

class _AddItemToBdScreenState extends State<AddItemToBdScreen> {
